...
export function ScrollToTop() {
  ...
  return (
    <button
      ...
      onClick={scrollTop}
      className={`fixed bottom-10 left-4 z-40 grid h-8 w-8 place-items-center rounded-full text-white shadow-xl shadow-blue-500/30 ring-1 ring-white/30 transition-all duration-300 hover:scale-110 hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--brand-cyan) sm:bottom-12 sm:left-6 ${
        visible
